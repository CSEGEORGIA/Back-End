...
import ge.cse.lms.DTOs.appuser.UserCredentials;
...
public class AuthController {
    ...
    public String generateJWT(@RequestBody UserCredentials userCredentials) throws UnknownHostException {
        String url = "http://" + InetAddress.getLoopbackAddress().getHostAddress() + ":" + environment.getProperty("local.server.port") + "/cse/auth";//"http://localhost:8080/auth";
